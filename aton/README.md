...
Взял датасет с фильмами и реализовал двузуровневую систему, тут еще можно ,помимо более крутых моделей, и фичи получше сделать + отборщик фичей и настройку гиперпараметров.
